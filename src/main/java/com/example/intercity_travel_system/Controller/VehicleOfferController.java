...
public class VehicleOfferController {
    ...
    @PostMapping("/add")
    public ResponseEntity addVehicleOffer(@Valid @RequestBody VehicleOffer vehicleOffer) {
    ...
    public ResponseEntity updateVehicleOffer(@PathVariable Integer id, @Valid @RequestBody VehicleOffer vehicleOffer) {
