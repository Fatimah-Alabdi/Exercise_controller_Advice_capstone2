...
public class TripRequestController {
    ...
    @PostMapping("/add")
    public ResponseEntity addTripRequest(@Valid@RequestBody TripRequest tripRequest){
    ...
    public ResponseEntity updateTripRequest(@PathVariable Integer id,@Valid@RequestBody TripRequest tripRequest){
